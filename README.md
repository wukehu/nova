...
| 测试 | 基础测试模板 | 基础测试模板 | **技术栈测试 + Playwright + CI/CD** |
| 发布 | 无发布命令 | 无统一发布 | **标准化发布流程** |
| 文档 | 手动生成 | 自动文档生成 | **自动生成 + 技术栈提取** |
| 智能化 | 无 | 无 | 无 | AI 智能辅助（可选） |
...
### v2.0.3 - 全面升级（当前版本）
- 添加 6 个新工作流（feature-dev、hotfix、data-pipeline、ml-model、mobile-app、desktop-app）
- 添加 4 个新技术栈（Vue+Spring、Node.js、Svelte+Go、React Native）
- 添加 4 个新规则（documentation、reliability、scalability、accessibility）
- 添加 3 个新技能（security-audit、deployment、monitoring）
- 创建英文版 README（国际化）
- 实现完整度 100%
...
- [Nova 2.0 设计文档](docs/NOVA_2.0_IMPLEMENTATION_STATUS.md)
- [变更日志](CHANGELOG.md)
